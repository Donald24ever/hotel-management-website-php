					...
					<form class="reservation__form"> 
						<div class="form-group">
							<div class="form-group__inner"> 
								...
								<input type="text" class="form-control date" id="reservation__check-in" value="12 February 2018"> 
							</div> <!-- / .form-group__inner --> 
						</div> <!-- / .form-group --> 
						<div class="form-group"> 
							<div class="form-group__inner"> 
								<label for="reservation__check-out">Departure date</label>
								<input type="text" class="form-control date" id="reservation__check-out" value="12 February 2018">
							</div> <!-- / .form-group__inner --> 
						</div> <!-- / .form-group -->  
