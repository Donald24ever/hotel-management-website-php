        ...
        <div class="collapse navbar-collapse" id="navbar__collapse">
          <ul class="nav navbar-nav navbar-left">
            <li class="active"><a href="index.php">Home <span class="sr-only">(current)</span></a></li>
             <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Edit<i class="icon ion-chevron-down"></i></a>
            <ul class="dropdown-menu">
	            <li><a href="admin/insert_room.php">Insert Room</a></li>
	            <li><a href="admin/insert_cat.php">Insert Category</a></li>
	          </ul>
            </li>
            <li class="dropdown">
